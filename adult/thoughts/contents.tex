...
Standardization does not seem like a good solution, since the attributes do not look like Gaussian distributed. A normalized dataset however makes sense, and one is available in the Github repository for the project \cite{repo}.
